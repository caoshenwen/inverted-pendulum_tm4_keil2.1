...
{
	I2C3_Write_Byte(OLED_ADDR, 0x00, oled_Command);
}

void oled_WriteDat(unsigned char oled_Data)
{
	I2C3_Write_Byte(OLED_ADDR, 0x40, oled_Data);
}

void OLED_Init(void)
{
	int i = 0;
	ROM_SysCtlDelay(SysCtlClockGet()/6/10);			// delay_ms(100);
	...
	oled_WriteCmd(0xff); 	//adjust brightness 0x00~0xff
